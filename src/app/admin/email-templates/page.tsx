  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-12 text-center">
        ...
        <h2 className="font-serif text-2xl font-bold text-[#1C1512] mb-2">Email Templates</h2>
        <p className="font-sans text-sm text-[#8C8682] max-w-xs leading-relaxed">Manage email templates sent to customers.</p>
